<div align="center">
  <img src="assets/banner.svg" alt="AI_Journey — documenting my path into AI, one project at a time" width="840">
</div>
...
|:--|:--|:--|
| 🤖 | **[Claude Masterclass](projects/Claude-Masterclass/)**<br><sub>Claude Code, Cowork, Skills and agents — a 158-lesson course</sub> | Section 8 of 14<br><sub>80 lessons watched</sub> |
| ☁️ | **[AWS AI Practitioner](projects/AWS-AI-Practitioner/)**<br><sub>The road to the AIF-C01 certification, via AWS Educate</sub> | Cloud 101 passed<br><sub>waiting on the exam voucher</sub> |
...
`README.md` — what the project is and where it stands<br>
`study-plan.md` — where it is going, and whether I am on schedule<br>
